Representational Harm in ClinicalBERT
Examining How Demographic Descriptors Shape Predictions of Behavioral and Evaluative Language in Clinical NLP
Overview
...
Methods
Method 1 — Log Probability Bias Analysis (LPBA)
...
├── lpba/
│   └── lpba_clinicalbert.py        # Full LPBA pipeline
├── probing/
│   └── probing_analysis.py         # MLM template probing + linear probe classifiers
├── results/
│   ├── lpba_raw_results.csv
│   ├── lpba_bias_metrics.csv
│   ├── lpba_statistical_tests.csv
│   ├── lpba_heatmap_by_category.png
│   ├── lpba_diverging_dot.png
│   ├── lpba_race_bars_by_category.png
│   └── lpba_gender_bars_by_category.png
├── requirements.txt
└── README.md
Dataset
